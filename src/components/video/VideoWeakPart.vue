...
<div class="weak-main">
  <div class="chartbox" >
    <div style="text-align: center; font-size: 2.5rem; margin-bottom: 50px;">나의 운동 분석 차트</div>
    <Radar 
  ...
  <div class="result" data-aos="zoom-in-up" data-aos-duration="3000">
    <div class="grass">잔디 건강 지표</div>
    <div class="icon" v-if="result == 'good'">
    <font-awesome-icon icon="fa-solid fa-face-grin-hearts" />
    </div>
